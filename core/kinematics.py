...
3. Mount offset quaternion: q_offset = conj(q_calib) * q_desired
4. Apply mount offset on the RIGHT, then common heading correction on the LEFT
...
class KinematicsProcessor:
    ...
    1. Calibration applies sensor mount offset on the RIGHT
    2. Initial subject heading is reset with a common LEFT yaw correction
    3. Apply: q_cal = q_heading_correction * (q_raw * q_offset)
